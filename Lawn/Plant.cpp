...
PlantDefinition gPlantDefs[SeedType::NUM_SEED_TYPES] = {  
    { SeedType::SEED_PEASHOOTER,        nullptr, ReanimationType::REANIM_PEASHOOTER,    0,  0,      PlantsRechargeTime::SLOW,       PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("PEASHOOTER"),       ScoreType::BASIC, 2},
    { SeedType::SEED_SUNFLOWER,         nullptr, ReanimationType::REANIM_SUNFLOWER,     1,  0,      PlantsRechargeTime::SNAIL,      PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("SUNFLOWER"),        ScoreType::BASIC, 0},
    { SeedType::SEED_CHERRYBOMB,        nullptr, ReanimationType::REANIM_CHERRYBOMB,    3,  0,      PlantsRechargeTime::SNAIL,      PlantSubClass::SUBCLASS_NORMAL,     0,      _S("CHERRY_BOMB"),      ScoreType::INSTANT, 2},
    { SeedType::SEED_WALLNUT,           nullptr, ReanimationType::REANIM_WALLNUT,       2,  0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("WALL_NUT"),         ScoreType::BASIC, 3},
    { SeedType::SEED_POTATOMINE,        nullptr, ReanimationType::REANIM_POTATOMINE,    37, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("POTATO_MINE"),      ScoreType::BASIC, 3},
    { SeedType::SEED_SNOWPEA,           nullptr, ReanimationType::REANIM_SNOWPEA,       4,  0,      PlantsRechargeTime::SNAIL,      PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("SNOW_PEA"),         ScoreType::BASIC, 5},
    { SeedType::SEED_CHOMPER,           nullptr, ReanimationType::REANIM_CHOMPER,       31, 0,      PlantsRechargeTime::VERY_SLOW,  PlantSubClass::SUBCLASS_NORMAL,     0,      _S("CHOMPER"),          ScoreType::BASIC, 6},
    { SeedType::SEED_REPEATER,          nullptr, ReanimationType::REANIM_REPEATER,      5,  0,      PlantsRechargeTime::VERY_SLOW,  PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("REPEATER"),         ScoreType::BASIC, 4},
    { SeedType::SEED_PUFFSHROOM,        nullptr, ReanimationType::REANIM_PUFFSHROOM,    6,  0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("PUFF_SHROOM"),      ScoreType::BASIC, 1},
    { SeedType::SEED_SUNSHROOM,         nullptr, ReanimationType::REANIM_SUNSHROOM,     7,  0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("SUN_SHROOM"),       ScoreType::BASIC, 0},
    { SeedType::SEED_FUMESHROOM,        nullptr, ReanimationType::REANIM_FUMESHROOM,    9,  0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("FUME_SHROOM"),      ScoreType::COLUMN, 3},
    { SeedType::SEED_GRAVEBUSTER,       nullptr, ReanimationType::REANIM_GRAVE_BUSTER,  40, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("GRAVE_BUSTER"),     ScoreType::BASIC, 0},
    { SeedType::SEED_HYPNOSHROOM,       nullptr, ReanimationType::REANIM_HYPNOSHROOM,   10, 0,      PlantsRechargeTime::SLOW,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("HYPNO_SHROOM"),     ScoreType::INSTANT, 1},
    { SeedType::SEED_SCAREDYSHROOM,     nullptr, ReanimationType::REANIM_SCRAREYSHROOM, 33, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("SCAREDY_SHROOM"),   ScoreType::BASIC, 2},
    { SeedType::SEED_ICESHROOM,         nullptr, ReanimationType::REANIM_ICESHROOM,     36, 0,      PlantsRechargeTime::VERY_SLOW,  PlantSubClass::SUBCLASS_NORMAL,     0,      _S("ICE_SHROOM") },
    { SeedType::SEED_DOOMSHROOM,        nullptr, ReanimationType::REANIM_DOOMSHROOM,    20, 0,      PlantsRechargeTime::A_MONTH,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("DOOM_SHROOM") },
    { SeedType::SEED_LILYPAD,           nullptr, ReanimationType::REANIM_LILYPAD,       19, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("LILY_PAD"),         ScoreType::BASIC, 0},
    { SeedType::SEED_SQUASH,            nullptr, ReanimationType::REANIM_SQUASH,        21, 0,      3000,                           PlantSubClass::SUBCLASS_NORMAL,     0,      _S("SQUASH") },
    { SeedType::SEED_THREEPEATER,       nullptr, ReanimationType::REANIM_THREEPEATER,   12, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("THREEPEATER"),      ScoreType::THREE_ROWS, 2},
    { SeedType::SEED_TANGLEKELP,        nullptr, ReanimationType::REANIM_TANGLEKELP,    17, 0,      3000,                           PlantSubClass::SUBCLASS_NORMAL,     0,      _S("TANGLE_KELP") },
    { SeedType::SEED_JALAPENO,          nullptr, ReanimationType::REANIM_JALAPENO,      11, 0,      5000,                           PlantSubClass::SUBCLASS_NORMAL,     0,      _S("JALAPENO") },
    { SeedType::SEED_SPIKEWEED,         nullptr, ReanimationType::REANIM_SPIKEWEED,     22, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("SPIKEWEED") },
    { SeedType::SEED_TORCHWOOD,         nullptr, ReanimationType::REANIM_TORCHWOOD,     29, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("TORCHWOOD"),        },
    { SeedType::SEED_TALLNUT,           nullptr, ReanimationType::REANIM_TALLNUT,       28, 0,      3000,                           PlantSubClass::SUBCLASS_NORMAL,     0,      _S("TALL_NUT") },
    { SeedType::SEED_SEASHROOM,         nullptr, ReanimationType::REANIM_SEASHROOM,     39, 0,      3000,                           PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("SEA_SHROOM"),       ScoreType::BASIC, 1},
    { SeedType::SEED_PLANTERN,          nullptr, ReanimationType::REANIM_PLANTERN,      38, 0,      3000,                           PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("PLANTERN"),         ScoreType::BASIC, 0},
    { SeedType::SEED_CACTUS,            nullptr, ReanimationType::REANIM_CACTUS,        15, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("CACTUS") },
    { SeedType::SEED_BLOVER,            nullptr, ReanimationType::REANIM_BLOVER,        18, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("BLOVER") },
    { SeedType::SEED_SPLITPEA,          nullptr, ReanimationType::REANIM_SPLITPEA,      32, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("SPLIT_PEA"),        ScoreType::BASIC, 3},
    { SeedType::SEED_STARFRUIT,         nullptr, ReanimationType::REANIM_STARFRUIT,     30, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("STARFRUIT"),        ScoreType::BASIC, 3},
    { SeedType::SEED_PUMPKINSHELL,      nullptr, ReanimationType::REANIM_PUMPKIN,       25, 0,      3000,                           PlantSubClass::SUBCLASS_NORMAL,     0,      _S("PUMPKIN") },
    { SeedType::SEED_MAGNETSHROOM,      nullptr, ReanimationType::REANIM_MAGNETSHROOM,  35, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("MAGNET_SHROOM") },
    { SeedType::SEED_CABBAGEPULT,       nullptr, ReanimationType::REANIM_CABBAGEPULT,   13, 0,      PlantsRechargeTime::SLOW,       PlantSubClass::SUBCLASS_SHOOTER,    300,    _S("CABBAGE_PULT") },
    { SeedType::SEED_FLOWERPOT,         nullptr, ReanimationType::REANIM_FLOWER_POT,    33, 0,      PlantsRechargeTime::AVERAGE,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("FLOWER_POT"),       ScoreType::BASIC, 0},
    { SeedType::SEED_KERNELPULT,        nullptr, ReanimationType::REANIM_KERNELPULT,    13, 0,      PlantsRechargeTime::SLOW,       PlantSubClass::SUBCLASS_SHOOTER,    300,    _S("KERNEL_PULT") },
    { SeedType::SEED_INSTANT_COFFEE,    nullptr, ReanimationType::REANIM_COFFEEBEAN,    33, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("COFFEE_BEAN") },
    { SeedType::SEED_GARLIC,            nullptr, ReanimationType::REANIM_GARLIC,        8,  0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("GARLIC") },
    { SeedType::SEED_UMBRELLA,          nullptr, ReanimationType::REANIM_UMBRELLALEAF,  23, 0,      PlantsRechargeTime::SNAIL,      PlantSubClass::SUBCLASS_NORMAL,     0,      _S("UMBRELLA_LEAF"),    ScoreType::BASIC, 0},
    { SeedType::SEED_MARIGOLD,          nullptr, ReanimationType::REANIM_MARIGOLD,      24, 0,      3000,                           PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("MARIGOLD"),         ScoreType::BASIC, 0},
    { SeedType::SEED_MELONPULT,         nullptr, ReanimationType::REANIM_MELONPULT,     14, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_SHOOTER,    300,    _S("MELON_PULT") },
    { SeedType::SEED_GATLINGPEA,        nullptr, ReanimationType::REANIM_GATLINGPEA,    5,  0,      5000,                           PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("GATLING_PEA") },
    { SeedType::SEED_TWINSUNFLOWER,     nullptr, ReanimationType::REANIM_TWIN_SUNFLOWER,1,  0,      5000,                           PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("TWIN_SUNFLOWER") },
    { SeedType::SEED_GLOOMSHROOM,       nullptr, ReanimationType::REANIM_GLOOMSHROOM,   27, 0,      5000,                           PlantSubClass::SUBCLASS_SHOOTER,    200,    _S("GLOOM_SHROOM") },
    { SeedType::SEED_CATTAIL,           nullptr, ReanimationType::REANIM_CATTAIL,       27, 0,      5000,                           PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("CATTAIL") },
    { SeedType::SEED_WINTERMELON,       nullptr, ReanimationType::REANIM_WINTER_MELON,  27, 0,      5000,                           PlantSubClass::SUBCLASS_SHOOTER,    300,    _S("WINTER_MELON") },
    { SeedType::SEED_GOLD_MAGNET,       nullptr, ReanimationType::REANIM_GOLD_MAGNET,   27, 0,      5000,                           PlantSubClass::SUBCLASS_NORMAL,     0,      _S("GOLD_MAGNET") },
    { SeedType::SEED_SPIKEROCK,         nullptr, ReanimationType::REANIM_SPIKEROCK,     27, 0,      5000,                           PlantSubClass::SUBCLASS_NORMAL,     0,      _S("SPIKEROCK") },
    { SeedType::SEED_COBCANNON,         nullptr, ReanimationType::REANIM_COBCANNON,     16, 0,      5000,                           PlantSubClass::SUBCLASS_NORMAL,     600,    _S("COB_CANNON") },
    { SeedType::SEED_IMITATER,          nullptr, ReanimationType::REANIM_IMITATER,      33, 0,      PlantsRechargeTime::FAST,       PlantSubClass::SUBCLASS_NORMAL,     0,      _S("IMITATER"),         ScoreType::BASIC, 0},
...
void Plant::PlantInitialize(int theGridX, int theGridY, SeedType theSeedType, SeedType theImitaterType)
{
    ...
    mPlantHealth = PlantsAttributes::HEALTH;
    ...
    case SeedType::SEED_WALLNUT:
        mPlantHealth = PlantsAttributes::WallNut::HEALTH;
    ...
    case SeedType::SEED_TALLNUT:
        mPlantHealth = PlantsAttributes::TallNut::HEALTH;
        mHeight = 80;
        mBlinkCountdown = 1000 + Sexy::Rand(1000);
        break;
    ...
    case SeedType::SEED_POTATOMINE:
    {
        ...
        if (IsInPlay())
        {
            ...
            mStateCountdown = PLANT_POTATO_ARMING_COOLDOWN;
        }
        else
        {
...
void Plant::UpdateChomper()
{
    ...
    else if (mState == PlantState::STATE_CHOMPER_BITING)
    {
        if (mStateCountdown == 0)
        {
            ...
            {
                mApp->PlayFoley(FoleyType::FOLEY_SPLAT);
                aZombie->TakeDamage(PlantsAttributes::Chomper::BITE_DAMAGE, 0U);
